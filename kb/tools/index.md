...
| [probe-query.md](probe-query.md) | probe (query) | ~0.3K | Rust | Low |
...
- Working on entrypoint analysis or verified-dependency partitioning → [probe-query.md](probe-query.md)
